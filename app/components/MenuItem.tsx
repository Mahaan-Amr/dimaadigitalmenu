...
function formatPrice(price: number, language: 'en' | 'fa'): string {
  if (language === 'fa') {
    ...
    >
      ...
      <div className="p-4">
        ...
        >
          ...
          >
            {formatPrice(item.price[currentLanguage], currentLanguage)}
          </motion.span>
          <motion.span
            whileHover={{ scale: 1.05 }}
          ...
          {showDetails && (
            ...
            >
              <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                {item.ingredients[currentLanguage].map((ingredient, index) => (
                  <motion.li
                    key={index}
